...
export class TransactionService {
  ...
  //   score: number,
  // ): Promise<string> {
  //   return this.entityManage.transaction(async (manager) => {
  //     logger.info({
  ...
  //     logger.info({
  //       msg: 'Transaction broadcasted and confirmed as success',
  //       userId,
  //       address,
  //       txId,
  //     });

  //     savedSubmission.transactionId = txId;
  //     savedSubmission.transactionStatus = TransactionStatus.Success;
  //     await manager.save(savedSubmission);
