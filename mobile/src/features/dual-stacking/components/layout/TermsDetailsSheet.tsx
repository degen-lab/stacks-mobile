...
Any services or content accessible through the Website relating to the sBTC and/or STX token(s), their respective ecosystems and/or any associated project(s) is third-party content. Stacks Labs does not own, control, verify, update, or manage such services or content and assumes no responsibility for its quality, accessibility, compatibility, suitability, accuracy or completeness. Users are advised to independently verify all information and consult professional advisers before making decisions.
...
export function TermsDetailsSheet({ open, onOpenChange }: Props) {
  ...
  return (
    ...
    >
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
        <Text className="font-instrument-sans text-sm text-secondary leading-6 pb-10">
          {TERMS_TEXT}
        </Text>
        <View className="pb-6">
          <Button
